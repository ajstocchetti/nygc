<div class="three columns sidebar">
	<nav class="navSideBar">
		<a href="/">
		<img src="/images/NYGC_multiline_140x79.png" alt="New York Grant Company" style="padding-bottom:5px;" />
		...
		<form class="buttonlink" action="/staff"><input type="submit" class="buttonlink" value="Our Staff" /></form>
		<form class="buttonlink" action="/contact"><input type="submit" class="buttonlink" value="Contact Us" /></form>
	</nav>
	&nbsp;
</div>
